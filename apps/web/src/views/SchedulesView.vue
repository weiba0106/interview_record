...
<template>
  <main class="schedules-page page-center" aria-labelledby="schedules-heading">
    ...
    <ElDialog v-model="formDialogOpen" :title="editing ? '编辑日程' : '新增日程'" width="min(94vw, 560px)" top="6vh" :teleported="false">
      <ScheduleForm ref="schedule-form" :initial="editing" :positions="positions" @submitted="submitSchedule" />
    </ElDialog>
    ...
    <ScheduleReminderDialog v-model="reminderDialogOpen" :schedule="reminderTarget" @updated="onRemindersUpdated" />
  </main>
</template>
